        ...
        {!submitted ? (
          <>
            <div className="form0modal-header">
              <h2 className="form0modal-title">Purchase Advertising Package</h2>
              <p className="form0modal-subtitle">Select your package and provide your contact information to get started.</p>
            </div>
            ...
            <form className="form0modal-form" onSubmit={handleSubmit}>
              <div className="form0field-group">
                ...
                <div className="form0select-wrapper">
                  ...
                  >
                    <option value="">Choose an advertising package</option>
                    <option value="founding-member">Founding Member Package — $2,000</option>
                    <option value="6-month">6-Month Package — $1,250</option>
                    <option value="3-month">3-Month Package — $750</option>
                  </select>
          ...
          <div className="form0success-message">
            ...
            <p className="form0success-text">
              We've received your package purchase request. Our team will contact you shortly to complete the process.
            </p>
          </div>
        )}
      </div>
...
export default AdvertisePurchaseModal;
