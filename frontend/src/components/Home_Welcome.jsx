        ...
        <div className="home-welcome__content">
          <div className="home-welcome__left">
            ...
            <div className="home-welcome__text">
              ...
              <p>
                At Clip Culture, every cut is more than grooming—it's an experience, a connection, and a reflection of culture.
              </p>
            </div>
            
            <div className="home-welcome__cta">
              <Link to="/about" className="home-welcome__button">
                Read Full Story
              </Link>
              <div className="home-welcome__social">
                <a 
                  href="https://instagram.com" 
                  target="_blank" 
                  rel="noopener noreferrer" 
                  className="home-welcome__social-button home-welcome__social-button--instagram"
                ...
                <a 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer" 
                  className="home-welcome__social-button home-welcome__social-button--facebook"
          ...
          <div className="home-welcome__right">
            <img 
              src={DaveHomeImage} 
