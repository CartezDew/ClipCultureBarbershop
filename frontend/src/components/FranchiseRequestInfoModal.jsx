...
const FranchiseRequestInfoModal = ({ isOpen, onClose }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await submitFormWithAttachments('Franchise Request Info', formData);
      console.log('Franchise request submitted:', formData);
    } catch (error) {
        ...
        {!submitted ? (
          <>
            <div className="form0modal-header">
              <h2 className="form0modal-title">Request Franchise Information</h2>
              <p className="form0modal-subtitle">Fill out the form below and we'll send you detailed information about our franchise opportunities.</p>
            </div>
          ...
          <div className="form0success-message">
            ...
            <p className="form0success-text">
              We'll send you detailed franchise information shortly. Expect to hear from us within 24 hours.
            </p>
          </div>
        )}
      </div>
...
export default FranchiseRequestInfoModal;
